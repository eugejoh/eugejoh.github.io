...
This page contains some **data visualizations** on work I've done over the years using variety of R packages. Most of these are from previous blog posts demonstrating using R for data wrangling and visualization.
